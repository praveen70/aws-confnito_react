...
var Container = exports.Container = function Container(props) {
    ...
    var p = _core.JS.objectLessAttributes(props, 'theme');
    return beforeAfter(_react2.default.createElement(
        'div',
        (0, _extends3.default)({}, p, { className: 'amplify-container', style: style }),
        props.children
    ));
}; /*
...
var ErrorSection = exports.ErrorSection = function ErrorSection(props) {
    ...
    return beforeAfter(_react2.default.createElement(
        'div',
        (0, _extends3.default)({}, p, { className: 'amplify-error-section', style: style }),
...
var SectionHeader = exports.SectionHeader = function SectionHeader(props) {
    ...
    return beforeAfter(_react2.default.createElement(
        'div',
        (0, _extends3.default)({}, p, { className: 'amplify-section-header', style: style }),
        _react2.default.createElement(
...
var SectionFooter = exports.SectionFooter = function SectionFooter(props) {
    ...
    return beforeAfter(_react2.default.createElement(
        'div',
        (0, _extends3.default)({}, p, { className: 'amplify-section-footer', style: style }),
        _react2.default.createElement(
...
var SectionBody = exports.SectionBody = function SectionBody(props) {
    ...
    return beforeAfter(_react2.default.createElement(
        'div',
        (0, _extends3.default)({}, p, { className: 'amplify-section-body', style: style }),
        props.children
    ));
};
...
var ActionRow = exports.ActionRow = function ActionRow(props) {
    ...
    return beforeAfter(_react2.default.createElement(
        'div',
        (0, _extends3.default)({}, p, { className: 'amplify-action-row', style: style }),
        props.children
    ));
};
...
var FormRow = exports.FormRow = function FormRow(props) {
    ...
    return beforeAfter(_react2.default.createElement(
        'div',
        (0, _extends3.default)({}, p, { className: 'amplify-form-row', style: style }),
        props.children
    ));
};
...
var InputRow = exports.InputRow = function InputRow(props) {
    ...
    return _react2.default.createElement(
        FormRow,
        { theme: theme },
        beforeAfter(_react2.default.createElement('input', (0, _extends3.default)({}, p, {
...
var RadioRow = exports.RadioRow = function RadioRow(props) {
    ...
    return _react2.default.createElement(
        FormRow,
        { theme: theme },
        _react2.default.createElement(Radio, (0, _extends3.default)({}, props, {
            id: id
        })),
        _react2.default.createElement(
            Label,
...
var Radio = exports.Radio = function Radio(props) {
    ...
    var p = _core.JS.objectLessAttributes(props, 'theme');
    return beforeAfter(_react2.default.createElement('input', (0, _extends3.default)({}, p, {
        type: 'radio',
...
var CheckboxRow = exports.CheckboxRow = function CheckboxRow(props) {
    ...
    return _react2.default.createElement(
        FormRow,
        { theme: theme },
        _react2.default.createElement(Checkbox, (0, _extends3.default)({}, props, {
            id: id
        })),
        _react2.default.createElement(
            Label,
...
var Button = exports.Button = function Button(props) {
    ...
    return beforeAfter(_react2.default.createElement(
        'button',
        (0, _extends3.default)({}, p, { className: 'amplify-button', style: style }),
        _react2.default.createElement(
            ButtonContent,
            { theme: theme },
            props.children
...
var SignInButton = exports.SignInButton = function SignInButton(props) {
    ...
    return beforeAfter(_react2.default.createElement(
        'button',
        (0, _extends3.default)({}, p, { className: 'amplify-signin-button', style: style }),
        props.children
    ));
};
...
var Link = exports.Link = function Link(props) {
    ...
    return beforeAfter(_react2.default.createElement(
        'a',
        (0, _extends3.default)({}, p, { className: 'amplify-a', style: style }),
        props.children
    ));
};
...
var Label = exports.Label = function Label(props) {
    ...
    return beforeAfter(_react2.default.createElement(
        'label',
        (0, _extends3.default)({}, p, { className: 'amplify-label', style: style }),
        props.children
    ));
};
...
var Space = exports.Space = function Space(props) {
    ...
    return beforeAfter(_react2.default.createElement(
        'span',
        (0, _extends3.default)({}, p, { className: 'amplify-space', style: style }),
        props.children
    ));
};
...
var NavBar = exports.NavBar = function NavBar(props) {
    ...
    return beforeAfter(_react2.default.createElement(
        'div',
        (0, _extends3.default)({}, p, { className: 'amplify-nav-bar', style: style }),
        props.children
    ));
};
...
var Nav = exports.Nav = function Nav(props) {
    ...
    return beforeAfter(_react2.default.createElement(
        'div',
        (0, _extends3.default)({}, p, { className: 'amplify-nav', style: style }),
        props.children
    ));
};
...
var NavRight = exports.NavRight = function NavRight(props) {
    ...
    return beforeAfter(_react2.default.createElement(
        'div',
        (0, _extends3.default)({}, p, { className: 'amplify-nav-right', style: style }),
        props.children
    ));
};
...
var NavItem = exports.NavItem = function NavItem(props) {
    ...
    return beforeAfter(_react2.default.createElement(
        'div',
        (0, _extends3.default)({}, p, { className: 'amplify-nav-item', style: style }),
        props.children
    ));
};
...
var NavButton = exports.NavButton = function NavButton(props) {
    ...
    return beforeAfter(_react2.default.createElement(
        'button',
        (0, _extends3.default)({}, p, { className: 'amplify-nav-button', style: style }),
        beforeAfter(_react2.default.createElement(
            'span',
